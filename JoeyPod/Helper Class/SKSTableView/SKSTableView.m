...
//            expandableCell.separatorInset = UIEdgeInsetsZero;
        ...
        if (expandableCell.isExpandable)
        {
          //  [tableView selectRowAtIndexPath:indexPath animated:NO scrollPosition:NO];
            ...
            if (isExpanded)
            {
                ...
                expandableCell.backgroundColor = [UIColor hx_colorWithHexString:@"F7F9ED" alpha:1];
            ...
            else
            {
                ...
                expandableCell.backgroundColor = [UIColor hx_colorWithHexString:@"FFFFFF" alpha:1];
    ...
    else
    {
        ...
        SubRowTableViewCell *cell = (SubRowTableViewCell *)[_SKSTableViewDelegate tableView:(SKSTableView *)tableView cellForSubRowAtIndexPath:correspondingIndexPath];
        //cell.backgroundColor = [UIColor hx_colorWithHexString:@"FFFFFF" alpha:1];
        cell.backgroundColor = [UIColor hx_colorWithHexString:@"F7F9ED" alpha:1];
